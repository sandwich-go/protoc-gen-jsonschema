...
build:
	...
	@mkdir -p bin
	@go build -ldflags "-s -w" -o bin/protoc-gen-jsonschema cmd/protoc-gen-jsonschema/main.go
...
build_linux:
	...
	@GOOS=linux GOARCH=amd64 go build -ldflags "-s -w" -o bin/protoc-gen-jsonschema.linux-amd64 cmd/protoc-gen-jsonschema/main.go
